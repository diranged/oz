...
type AccessTemplateSpec struct {
	...
	// Foo is an example field of AccessTemplate. Edit accesstemplate_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// AccessTemplateStatus defines the observed state of AccessTemplate
