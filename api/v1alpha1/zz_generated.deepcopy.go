...
func (in *PodAccessTemplateSpec) DeepCopyInto(out *PodAccessTemplateSpec) {
	*out = *in
	in.AccessConfig.DeepCopyInto(&out.AccessConfig)
	out.ControllerTargetRef = in.ControllerTargetRef
	in.ControllerTargetMutationConfig.DeepCopyInto(&out.ControllerTargetMutationConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodSpecMutationConfig) DeepCopyInto(out *PodSpecMutationConfig) {
	*out = *in
	if in.Command != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodSpecMutationConfig.
func (in *PodSpecMutationConfig) DeepCopy() *PodSpecMutationConfig {
	if in == nil {
		return nil
	}
	out := new(PodSpecMutationConfig)
	in.DeepCopyInto(out)
	return out
}
