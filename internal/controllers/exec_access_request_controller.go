...
func (r *ExecAccessRequestReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &v1.Pod{}, v1alpha1.FieldSelectorMetadataName, func(rawObj client.Object) []string {
	...
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &v1.Pod{}, v1alpha1.FieldSelectorStatusPhase, func(rawObj client.Object) []string {
